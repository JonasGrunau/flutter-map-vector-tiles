...
- `test/label_continuity_test.dart` — cross-zoom label carry-over and
  ...
  two-copies-collide case a zoom crossing produces, and the ghost
  placement rules (a departing label never blocks or outranks a live one)
