...
| `label_continuity_test.dart` | Per-label fade and placement continuity, including clearing an in-progress fade when `labelFadeDuration` is disabled at runtime |
